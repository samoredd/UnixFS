...
void createDirectory(const std::string &dirName, int userId, int groupId) {
...
void addDirectoryEntry(int dirInodeIndex, const std::string &fileName, int fileInodeIndex, bool isDirectory) {
        Inode &dirInode = InodeManager::inodes[dirInodeIndex];
